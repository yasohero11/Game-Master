...
function installExtension(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            utils.logLabeledBullet(extensionsHelper_1.logPrefix, marked(`You can view your new instance in the Firebase console: ${utils.consoleUrl(projectId, `/extensions/instances/${instanceId}?tab=usage`)}`));
        }
        catch (err) {
            spinner.fail();
...
exports.default = new command_1.Command("ext:install <extensionName>")
    ...
    try {
        ...
        const sourceUrl = yield resolveSource_1.resolveSourceUrl(registryEntry, version);
